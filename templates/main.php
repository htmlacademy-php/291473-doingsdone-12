                ...
                <tr class="tasks__item task <?= $task['status'] ? 'task--completed' : '' ?> <?= htmlspecialchars(get_task_time($task)) ?>">
                    <td class="task__select">
                        <label class="checkbox task__checkbox">
                            <input class="checkbox__input visually-hidden task__checkbox" data-project="<?= htmlspecialchars($project_id) ?>" data-completed="<?= htmlspecialchars($show_complete_tasks) ?>" type="checkbox" value="<?= htmlspecialchars($task['id']) ?>" <?= $task['status'] === 1 ? 'checked' : '' ?>>
