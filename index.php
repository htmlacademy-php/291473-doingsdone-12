...
if (isset($_SESSION['user'])) {
    ...
    if ($search) {
        $search_query = "SELECT t.*, p.* FROM tasks t INNER JOIN users u ON u.id = t.user_id INNER JOIN projects p ON p.id = t.project_id WHERE u.id = '$user_id' AND MATCH(task_name) AGAINST(?) ORDER BY t.id DESC";
